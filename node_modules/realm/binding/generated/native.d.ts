...
export type ResumptionDelayInfo = {
  /** @default 3000000 */
  maxResumptionDelayInterval: Int64;
  /** @default 1000 */
...
export type ResumptionDelayInfo_Relaxed = {
  /** @default 3000000 */
  maxResumptionDelayInterval?: Int64;
  /** @default 1000 */
  resumptionDelayInterval?: Int64;
...
export type SaltedFileIdent = {
  /** @deprecated Add `ident` to your opt-in list (under `records/SaltedFileIdent/fields/`) to use this. */
  ident: Int64;
  /** @deprecated Add `salt` to your opt-in list (under `records/SaltedFileIdent/fields/`) to use this. */
  salt: Int64;
};
export type SaltedFileIdent_Relaxed = {
  /** @deprecated Add `ident` to your opt-in list (under `records/SaltedFileIdent/fields/`) to use this. */
  ident: Int64;
  /** @deprecated Add `salt` to your opt-in list (under `records/SaltedFileIdent/fields/`) to use this. */
  salt: Int64;
...
export class Helpers {
  ...
  static makeLoggerFactory(
    log: (category: Readonly<string>, level: LoggerLevel, message: Readonly<string>) => void,
  ): LoggerFactory;
...
export class LogCategoryRef {
  ...
  /** @deprecated Add `get_default_level_threshold` to your opt-in list (under `classes/LogCategoryRef/methods/`) to use this. */
...
export class Obj {
  ...
  /** @deprecated Add `set_collection` to your opt-in list (under `classes/Obj/methods/`) to use this. */
...
export class Results {
  ...
  /** @deprecated Add `get_list` to your opt-in list (under `classes/Results/methods/`) to use this. */
  getList(index: number): List;
  /** @deprecated Add `get_dictionary` to your opt-in list (under `classes/Results/methods/`) to use this. */
...
export class List extends Collection {
  ...
  private constructor();
  /** @deprecated Add `get_obj` to your opt-in list (under `classes/List/methods/`) to use this. */
  getObj(ndx: number): Obj;
  /** @deprecated Add `get_list` to your opt-in list (under `classes/List/methods/`) to use this. */
  getList(path_elem: number): List;
  /** @deprecated Add `get_dictionary` to your opt-in list (under `classes/List/methods/`) to use this. */
  ...
  /** @deprecated Add `insert_collection` to your opt-in list (under `classes/List/methods/`) to use this. */
  ...
  /** @deprecated Add `set_collection` to your opt-in list (under `classes/List/methods/`) to use this. */
...
export class Set extends Collection {
  private brandForSet;
  private constructor();
  /** @deprecated Add `get_obj` to your opt-in list (under `classes/Set/methods/`) to use this. */
  getObj(ndx: number): Obj;
...
export class Dictionary extends Collection {
  ...
  /** @deprecated Add `get_list` to your opt-in list (under `classes/Dictionary/methods/`) to use this. */
  getList(path_elem: string): List;
  /** @deprecated Add `get_dictionary` to your opt-in list (under `classes/Dictionary/methods/`) to use this. */
  ...
  /** @deprecated Add `insert_collection` to your opt-in list (under `classes/Dictionary/methods/`) to use this. */
...
export class UserSubscriptionToken {
...
export class User {
  ...
  private constructor();
  /** @deprecated Add `log_out` to your opt-in list (under `classes/User/methods/`) to use this. */
  logOut(): void;
  ...
  /** @deprecated Add `create_file_action` to your opt-in list (under `classes/User/methods/`) to use this. */
  createFileAction(
    action: SyncFileAction,
    original_path: string,
    requested_recovery_dir: undefined | string,
    partition_value: string,
  ): string;
  readonly userId: string;
  readonly appId: string;
  readonly legacyIdentities: Array<string>;
  readonly accessToken: string;
  readonly refreshToken: string;
  readonly state: SyncUserState;
  /** @deprecated Add `is_anonymous` to your opt-in list (under `classes/User/methods/`) to use this. */
  ...
  /** @deprecated Add `subscribers_count` to your opt-in list (under `classes/User/methods/`) to use this. */
  readonly subscribersCount: number;
  readonly app: App;
  /** @deprecated Add `DOLLAR_addr` to your opt-in list (under `classes/User/methods/`) to use this. */
  readonly $addr: number;
  /** @deprecated Add `DOLLAR_resetSharedPtr` to your opt-in list (under `classes/User/methods/`) to use this. */
  $resetSharedPtr(): void;
}
...
export class App {
  ...
  getBaseUrl(): string;
  /** @deprecated Add `immediately_run_file_actions` to your opt-in list (under `classes/App/methods/`) to use this. */
...
export class AsyncOpenTask {
  ...
  cancel(): void;
  registerDownloadProgressNotifier(
    callback: (transferred_bytes: Int64, transferrable_bytes: Int64, progress_estimate: number) => void,
  ): Int64;
...
export class SyncSession {
  ...
  /** @deprecated Add `get_file_ident` to your opt-in list (under `classes/SyncSession/methods/`) to use this. */
