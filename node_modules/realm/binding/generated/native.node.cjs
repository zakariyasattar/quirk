...
exports.WeakSyncSession = exports.WeakRef = exports.WatchStream = exports.UsernamePasswordProviderClient = exports.UserSubscriptionToken = exports.UserProfile = exports.UserApiKeyProviderClient = exports.User = exports.Transaction = exports.Timestamp = exports.ThreadSafeReference = exports.TableView = exports.TableRef = exports.SyncUser = exports.SyncSubscriptionSet = exports.SyncSession = exports.SyncManager = exports.SslVerifyCallback = exports.SortDescriptor = exports.Set = exports.Scheduler = exports.Results = exports.RealmCoordinator = exports.Realm = exports.Query = exports.PushClient = exports.ObjectStore = exports.ObjectNotifier = exports.ObjLink = exports.Obj = exports.NotificationToken = exports.MutableSyncSubscriptionSet = exports.LoggerFactory = exports.Logger = exports.LogCategoryRef = exports.List = exports.KeyPathMapping = exports.JsPlatformHelpers = exports.Int64 = exports.IndexSet = exports.Helpers = exports.GoogleIdToken = exports.GoogleAuthCode = exports.Geospatial = exports.GenericNetworkTransport = exports.Dictionary = exports.ConstTableRef = exports.Collection = exports.AsyncOpenTask = exports.AppSubscriptionToken = exports.AppCredentials = exports.App = void 0;
...
const _native_Helpers_sync_user_as_app_user = nativeModule.Helpers_sync_user_as_app_user;
const _native_Helpers_app_user_as_sync_user = nativeModule.Helpers_app_user_as_sync_user;
class Helpers {
  constructor(ptr) {
  ...
  static syncUserAsAppUser(sync_user) {
    return _native_Helpers_sync_user_as_app_user(sync_user);
  }
  static appUserAsSyncUser(sync_user) {
    return _native_Helpers_app_user_as_sync_user(sync_user);
  }
}
...
class LogCategoryRef {
  ...
  static _extract(self) {
    if (!(self instanceof LogCategoryRef)) throw new TypeError("Expected a LogCategoryRef");
    const out = self[_LogCategoryRef_Symbol];
    if (!out) throw new TypeError("received an improperly constructed LogCategoryRef");
    return out;
  }
...
exports.LogCategoryRef = LogCategoryRef;
...
const _UserSubscriptionToken_Symbol = Symbol("Realm.UserSubscriptionToken.external_pointer");
class UserSubscriptionToken {
  constructor(ptr) {
    this[_UserSubscriptionToken_Symbol] = ptr;
  }
  static _extract(self) {
    if (!(self instanceof UserSubscriptionToken)) throw new TypeError("Expected a UserSubscriptionToken");
    const out = self[_UserSubscriptionToken_Symbol];
    if (!out) throw new TypeError("received an improperly constructed UserSubscriptionToken");
    return out;
  }
}
exports.UserSubscriptionToken = UserSubscriptionToken;
...
const _User_Symbol = Symbol("Realm.User.external_pointer");
const _native_User_subscribe = nativeModule.User_subscribe;
const _native_User_unsubscribe = nativeModule.User_unsubscribe;
const _native_User_path_for_realm = nativeModule.User_path_for_realm;
const _native_User_access_token_refresh_required = nativeModule.User_access_token_refresh_required;
const _native_User_request_refresh_location = nativeModule.User_request_refresh_location;
const _native_User_request_access_token = nativeModule.User_request_access_token;
const _native_User_track_realm = nativeModule.User_track_realm;
const _native_User_user_id = nativeModule.User_user_id;
const _native_User_app_id = nativeModule.User_app_id;
const _native_User_legacy_identities = nativeModule.User_legacy_identities;
const _native_User_access_token = nativeModule.User_access_token;
const _native_User_refresh_token = nativeModule.User_refresh_token;
const _native_User_state = nativeModule.User_state;
const _native_User_device_id = nativeModule.User_device_id;
const _native_User_has_device_id = nativeModule.User_has_device_id;
const _native_User_user_profile = nativeModule.User_user_profile;
const _native_User_identities = nativeModule.User_identities;
const _native_User_custom_data = nativeModule.User_custom_data;
const _native_User_app = nativeModule.User_app;
class User {
  constructor(ptr) {
    this[_User_Symbol] = ptr;
  }
  static _extract(self) {
    if (!(self instanceof User)) throw new TypeError("Expected a User");
    const out = self[_User_Symbol];
    if (!out) throw new TypeError("received an improperly constructed User");
    return out;
  }
  subscribe(observer) {
    return _native_User_subscribe(this[_User_Symbol], observer);
  }
  unsubscribe(token) {
    return _native_User_unsubscribe(this[_User_Symbol], token);
  }
  pathForRealm(config, custom_file_name) {
    return _native_User_path_for_realm(this[_User_Symbol], config, custom_file_name);
  }
  accessTokenRefreshRequired() {
    return _native_User_access_token_refresh_required(this[_User_Symbol]);
  }
  requestRefreshLocation() {
    return _promisify(false, _cb => _native_User_request_refresh_location(this[_User_Symbol], _cb));
  }
  requestAccessToken() {
    return _promisify(false, _cb => _native_User_request_access_token(this[_User_Symbol], _cb));
  }
  trackRealm(path) {
    return _native_User_track_realm(this[_User_Symbol], path);
  }
  get userId() {
    return _native_User_user_id(this[_User_Symbol]);
  }
  get appId() {
    return _native_User_app_id(this[_User_Symbol]);
  }
  get legacyIdentities() {
    return _native_User_legacy_identities(this[_User_Symbol]);
  }
  get accessToken() {
    return _native_User_access_token(this[_User_Symbol]);
  }
  get refreshToken() {
    return _native_User_refresh_token(this[_User_Symbol]);
  }
  get state() {
    return _native_User_state(this[_User_Symbol]);
  }
  get deviceId() {
    return _native_User_device_id(this[_User_Symbol]);
  }
  get hasDeviceId() {
    return _native_User_has_device_id(this[_User_Symbol]);
  }
  get userProfile() {
    return _native_User_user_profile(this[_User_Symbol]);
  }
  get identities() {
    return _native_User_identities(this[_User_Symbol]);
  }
  get customData() {
    return _native_User_custom_data(this[_User_Symbol]);
  }
  get app() {
    return _native_User_app(this[_User_Symbol]);
  }
}
exports.User = User;
...
const _native_App_update_base_url = nativeModule.App_update_base_url;
const _native_App_get_base_url = nativeModule.App_get_base_url;
...
class App {
  ...
  updateBaseUrl(base_url) {
    return _promisify(false, _cb => _native_App_update_base_url(this[_App_Symbol], base_url, _cb));
  }
  getBaseUrl() {
    return _native_App_get_base_url(this[_App_Symbol]);
  }
  static getApp(mode, config) {
    return _native_App_get_app(mode, config);
  }
...
const _native_SyncManager_get_existing_active_session = nativeModule.SyncManager_get_existing_active_session;
const _native_SyncManager_get_all_sessions_for = nativeModule.SyncManager_get_all_sessions_for;
...
class SyncManager {
  ...
  getExistingActiveSession(path) {
    return _native_SyncManager_get_existing_active_session(this[_SyncManager_Symbol], path);
  }
  getAllSessionsFor(user) {
    return _native_SyncManager_get_all_sessions_for(this[_SyncManager_Symbol], user);
  }
